...
export const ItemCard = ({ inventoryDto, token }: { inventoryDto: InventoryDto; token: string; }) => {
  ...
  return (
    <div className="bg-white border border-gray-100 rounded-lg w-full mb-2 flex flex-col overflow-hidden shadow-sm">
      <div className="flex min-h-[5rem]">
        <figure className="w-20 shrink-0 bg-gray-50 flex items-center justify-center">
          <img src={inventoryDto.pic} alt={inventoryDto.name} className="w-full h-full object-cover" />
        </figure>
